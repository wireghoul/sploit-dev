...
extern char MFNHashTypeSaltedOpenCL_IPB_source[];
#endif


MFNHashTypeSaltedOpenCL_IPB::MFNHashTypeSaltedOpenCL_IPB() :  MFNHashTypePlainOpenCL(16) {
    trace_printf("MFNHashTypeSaltedOpenCL_IPB::MFNHashTypeSaltedOpenCL_IPB()\n");
    this->hashAttributes.hashWordWidth32 = 1;
    this->hashAttributes.hashUsesSalt = 1;
}

void MFNHashTypeSaltedOpenCL_IPB::launchKernel() {
    trace_printf("MFNHashTypeSaltedOpenCL_IPB::launchKernel()\n");
...
void MFNHashTypeSaltedOpenCL_IPB::printLaunchDebugData() {
...
void MFNHashTypeSaltedOpenCL_IPB::copyConstantDataToDevice() {
    trace_printf("MFNHashTypeSaltedOpenCL_IPB::copyConstantDataToDevice()\n");
...
void MFNHashTypeSaltedOpenCL_IPB::copySaltConstantsToDevice() {
    trace_printf("MFNHashTypeSaltedOpenCL_IPB::copySaltConstantsToDevice()\n");
...
std::string MFNHashTypeSaltedOpenCL_IPB::getKernelSourceString() {
    ...
    ReturnString += std::string(MFNHashTypeSaltedOpenCL_IPB_source);
#endif
    
    return ReturnString;
}

std::vector<std::string> MFNHashTypeSaltedOpenCL_IPB::getHashFileNames() {
    trace_printf("MFNHashTypeSaltedOpenCL_IPB::getHashFileNames()\n");
    ...
    returnHashFilenames.push_back(hashFilename);
    hashFilename = "./src/MFN_OpenCL_device/MFNHashTypeSaltedOpenCL_IPB.cl";
    returnHashFilenames.push_back(hashFilename);
#endif
    return returnHashFilenames;
}
    
std::string MFNHashTypeSaltedOpenCL_IPB::getHashKernelName() {
    trace_printf("MFNHashTypeSaltedOpenCL_IPB::getHashKernelName()\n");
    
    std::string hashKernel = "MFNHashTypeSaltedOpenCL_IPB";
    return hashKernel;
}

std::string MFNHashTypeSaltedOpenCL_IPB::getDefineStrings() {
    ...
    additionalDefines += 
            ...
            std::string("IPB_LOAD_PASSWORDS_FROM_GLOBAL()"));
