...
void bulkSSE2MD4(unsigned char *inputArrays, unsigned char length, unsigned char *outputHash) {
    ...
    static __m128i a4, b4, c4, d4, tmp1_4, tmp2_4;
    ...
    a = mCa; a2 = mCa; a3 = mCa; a4 = mCa;
    b = mCb; b2 = mCb; b3 = mCb; b4 = mCb;
    c = mCc; c2 = mCc; c3 = mCc; c4 = mCc;
    d = mCd; d2 = mCd; d3 = mCd; d4 = mCd;

    MD4_STEPS();

    // Add the initial values in again.
    a = _mm_add_epi32(a,mCa); a2 = _mm_add_epi32(a2,mCa); a3 = _mm_add_epi32(a3,mCa); a4 = _mm_add_epi32(a4,mCa);
    b = _mm_add_epi32(b,mCb); b2 = _mm_add_epi32(b2,mCb); b3 = _mm_add_epi32(b3,mCb); b4 = _mm_add_epi32(b4,mCb);
    c = _mm_add_epi32(c,mCc); c2 = _mm_add_epi32(c2,mCc); c3 = _mm_add_epi32(c3,mCc); c4 = _mm_add_epi32(c4,mCc);
    d = _mm_add_epi32(d,mCd); d2 = _mm_add_epi32(d2,mCd); d3 = _mm_add_epi32(d3,mCd); d4 = _mm_add_epi32(d4,mCd);
/*
