...
extern "C" void copyConstantsToSHA1(char *HOST_Charset, UINT4 HOST_Charset_Length,
    UINT4 HOST_Chain_Length, UINT4 HOST_Number_Of_Chains, UINT4 HOST_Table_Index,
    UINT4 HOST_Number_Of_Threads);

extern "C" void LaunchGenerateKernelSHA1(int passwordLength, UINT4 CUDA_Blocks, UINT4 CUDA_Threads,
...
void GRTGenerateTableSHA1::copyConstantsToGPU(char *HOST_Charset, UINT4 HOST_Charset_Length,
        UINT4 HOST_Chain_Length, UINT4 HOST_Number_Of_Chains, UINT4 HOST_Table_Index,
        UINT4 HOST_Number_Of_Threads) {

    copyConstantsToSHA1(HOST_Charset, HOST_Charset_Length,
    HOST_Chain_Length, HOST_Number_Of_Chains, HOST_Table_Index,
    HOST_Number_Of_Threads);
}


GRTGenerateTableSHA1::GRTGenerateTableSHA1() : GRTGenerateTable(20, 16) {
    return;
}

void GRTGenerateTableSHA1::runKernel(int passwordLength, UINT4 CUDA_Blocks,
    ...
    LaunchGenerateKernelSHA1(passwordLength, CUDA_Blocks,
