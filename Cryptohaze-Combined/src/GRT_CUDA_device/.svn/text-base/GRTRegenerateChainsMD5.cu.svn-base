...
extern "C" void copyMD5RegenerateDataToConstant(char *hostCharset, uint32_t hostCharsetLength,
    ...
    CH_CUDA_SAFE_CALL(cudaMemcpyToSymbol(MD5_Regenerate_Device_Charset_Constant, hostCharset, 512));
    CH_CUDA_SAFE_CALL(cudaMemcpyToSymbol(MD5_Regenerate_Device_Charset_Length, &hostCharsetLength, sizeof(uint32_t)));
    CH_CUDA_SAFE_CALL(cudaMemcpyToSymbol(MD5_Regenerate_Device_Chain_Length, &hostChainLength, sizeof(uint32_t)));
    CH_CUDA_SAFE_CALL(cudaMemcpyToSymbol(MD5_Regenerate_Device_Table_Index, &hostTableIndex, sizeof(uint32_t)));
    CH_CUDA_SAFE_CALL(cudaMemcpyToSymbol(MD5_Regenerate_Device_Number_Of_Threads, &hostNumberOfThreads, sizeof(uint32_t)));
    CH_CUDA_SAFE_CALL(cudaMemcpyToSymbol(constantBitmap, hostBitmap, 8192));
    CH_CUDA_SAFE_CALL(cudaMemcpyToSymbol(MD5_Regenerate_Device_Number_Of_Hashes, &hostNumberOfHashes, sizeof(uint32_t)));
}

extern "C" void setMD5RegenerateNumberOfChains(uint32_t numberOfChains) {
    CH_CUDA_SAFE_CALL(cudaMemcpyToSymbol(MD5_Regenerate_Device_Number_Of_Chains_To_Regen, &numberOfChains, sizeof(uint32_t)));
}
