...
/**
 * This file contains a SHA256 implementation for OpenCL.  It shouldn't need
 * terribly many implementations, but feel free to add some if needed (null
 * input data, perhaps?)
 */


#define SHA256_ROTL(val, bits) rotate(val, (unsigned int)bits)
#define SHA256_ROTR(val, bits) rotate(val, (unsigned int)(32 - bits))
...
#define OPENCL_SHA256_SECOND_ROUND(prev_a, prev_b, prev_c, prev_d,\
    prev_e, prev_f, prev_g, prev_h) { \
    vector_type temp1, temp2; \
    P( a, b, c, d, e, f, g, h,  b0, 0x428A2F98 ); \
    P( h, a, b, c, d, e, f, g,  b1, 0x71374491 ); \
    P( g, h, a, b, c, d, e, f,  b2, 0xB5C0FBCF ); \
