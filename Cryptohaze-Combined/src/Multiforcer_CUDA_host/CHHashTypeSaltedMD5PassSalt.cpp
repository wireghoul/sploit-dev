...
CHHashTypeSaltedMD5PassSalt::CHHashTypeSaltedMD5PassSalt() : CHHashTypeSalted(MD5_HASH_LENGTH, MAX_SALT_LENGTH) {

}


void CHHashTypeSaltedMD5PassSalt::copyDataToConstant(char *hostCharset, int charsetLength,
        unsigned char *hostCharsetLengths, unsigned char *hostSharedBitmap, int threadId) {
    copySaltedMD5PassSaltDataToConstant(hostCharset, charsetLength, hostCharsetLengths,
            hostSharedBitmap, threadId, this->SaltList, this->SaltLengths, this->NumberOfHashes);
}

void CHHashTypeSaltedMD5PassSalt::Launch_CUDA_Kernel(int passlength, uint64_t charsetLength, int numberOfPasswords, unsigned char *DEVICE_Passwords,
    ...
    Launch_CUDA_SaltedMD5PassSalt_Kernel(passlength, charsetLength, numberOfPasswords,
