...
CHHashTypeSaltedMD5SaltPass::CHHashTypeSaltedMD5SaltPass() : CHHashTypeSalted(MD5_HASH_LENGTH, MAX_SALT_LENGTH) {

}


void CHHashTypeSaltedMD5SaltPass::copyDataToConstant(char *hostCharset, int charsetLength,
        unsigned char *hostCharsetLengths, unsigned char *hostSharedBitmap, int threadId) {
    copySaltedMD5SaltPassDataToConstant(hostCharset, charsetLength, hostCharsetLengths,
            hostSharedBitmap, threadId, this->SaltList, this->SaltLengths, this->NumberOfHashes);
}

void CHHashTypeSaltedMD5SaltPass::Launch_CUDA_Kernel(int passlength, uint64_t charsetLength, int numberOfPasswords, unsigned char *DEVICE_Passwords,
    ...
    Launch_CUDA_SaltedMD5SaltPass_Kernel(passlength, charsetLength, numberOfPasswords,
