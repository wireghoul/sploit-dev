...
CHHashTypePlainMD5Single::CHHashTypePlainMD5Single() : CHHashTypePlain(16) {

}


void CHHashTypePlainMD5Single::copyDataToConstant(char *hostCharset, int charsetLength,
        unsigned char *hostCharsetLengths, unsigned char *hostSharedBitmap, int threadId) {
    copyMD5SingleDataToConstant(hostCharset, charsetLength, hostCharsetLengths, hostSharedBitmap, threadId);
}

void CHHashTypePlainMD5Single::Launch_CUDA_Kernel(int passlength, uint64_t charsetLength, int numberOfPasswords, unsigned char *DEVICE_Passwords,
    ...
    Launch_CUDA_MD5Single_Kernel(passlength, charsetLength, numberOfPasswords,
