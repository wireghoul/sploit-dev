...
CHHashTypePlainMySQL323::CHHashTypePlainMySQL323() : CHHashTypePlain(8) {

}


void CHHashTypePlainMySQL323::copyDataToConstant(char *hostCharset, int charsetLength,
        unsigned char *hostCharsetLengths, unsigned char *hostSharedBitmap, int threadId) {
    copyMySQL323DataToConstant(hostCharset, charsetLength, hostCharsetLengths, hostSharedBitmap, threadId);
}

void CHHashTypePlainMySQL323::Launch_CUDA_Kernel(int passlength, uint64_t charsetLength, int numberOfPasswords, unsigned char *DEVICE_Passwords,
    ...
    Launch_CUDA_MySQL323_Kernel(passlength, charsetLength, numberOfPasswords,
