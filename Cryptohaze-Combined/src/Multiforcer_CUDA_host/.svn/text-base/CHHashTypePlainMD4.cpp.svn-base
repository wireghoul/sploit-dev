...
CHHashTypePlainMD4::CHHashTypePlainMD4() : CHHashTypePlain(16) {

}


void CHHashTypePlainMD4::copyDataToConstant(char *hostCharset, int charsetLength,
        unsigned char *hostCharsetLengths, unsigned char *hostSharedBitmap, int threadId) {
    copyMD4DataToConstant(hostCharset, charsetLength, hostCharsetLengths, hostSharedBitmap, threadId);
}

void CHHashTypePlainMD4::Launch_CUDA_Kernel(int passlength, uint64_t charsetLength, int numberOfPasswords, unsigned char *DEVICE_Passwords,
    ...
    Launch_CUDA_MD4_Kernel(passlength, charsetLength, numberOfPasswords,
