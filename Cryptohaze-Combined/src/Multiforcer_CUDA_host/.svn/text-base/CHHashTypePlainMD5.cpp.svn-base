...
CHHashTypePlainMD5::CHHashTypePlainMD5() : CHHashTypePlain(16) {
    
}


void CHHashTypePlainMD5::copyDataToConstant(char *hostCharset, int charsetLength,
        unsigned char *hostCharsetLengths, unsigned char *hostSharedBitmap, int threadId) {
    copyMD5DataToConstant(hostCharset, charsetLength, hostCharsetLengths, hostSharedBitmap, threadId);
}

void CHHashTypePlainMD5::Launch_CUDA_Kernel(int passlength, uint64_t charsetLength, int numberOfPasswords, unsigned char *DEVICE_Passwords,
    ...
    Launch_CUDA_MD5_Kernel(passlength, charsetLength, numberOfPasswords,
