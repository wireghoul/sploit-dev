...
#ifndef _CHCHARSETMULTI_H
#define _CHCHARSETMULTI_H

#include "Multiforcer_Common/CHCommon.h"
#include "CH_Common/CHCharset.h"

class CHCharsetMulti : public CHCharset {
private:
    char Charset[MAX_CHARSET_LENGTH * MAX_PASSWORD_LEN];
    int CharsetNumberElements;
    int CharsetLength[MAX_PASSWORD_LEN];
public:
    CHCharsetMulti();
