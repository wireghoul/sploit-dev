...
// Implements the base64 encoded {SSHA} hash type

#ifndef _CHHASHFILETYPESALTEDSSHA_H
#define _CHHASHFILETYPESALTEDSSHA_H

#include "CH_Common/CHHashFileSalted32.h"


class CHHashFileSaltedSSHA : public CHHashFileSalted32 {
public:

    CHHashFileSaltedSSHA();
    ~CHHashFileSaltedSSHA();
