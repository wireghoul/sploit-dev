 ...
 * @section DESCRIPTION
 *
 * This class implements basic NTLM operations, used in a variety of places
 * throughout the projects.
 * 
 * Most of the NTLM code can be pulled from elsewhere in the project.  Please
 * ensure that the forward hash function works for all lengths!
 */

#ifndef __CHHASHIMPLEMENTATIONNTLM_H__
#define __CHHASHIMPLEMENTATIONNTLM_H__

#include <CH_Common/CHHashImplementation.h>

class CHHashImplementationNTLM : public CHHashImplementation {
public:
