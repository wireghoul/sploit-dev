 ...
 * @section DESCRIPTION
 *
 * This class implements basic MD5 operations, used in a variety of places
 * throughout the projects.
 * 
 * Most of the MD5 code can be pulled from elsewhere in the project.  Please
 * ensure that the forward hash function works for all lengths!
 */

#ifndef __CHHASHIMPLEMENTATIONMD5_H__
#define __CHHASHIMPLEMENTATIONMD5_H__

#include <CH_Common/CHHashImplementation.h>

class CHHashImplementationMD5 : public CHHashImplementation {
public:
