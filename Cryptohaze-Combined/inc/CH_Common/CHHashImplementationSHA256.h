 ...
 * @section DESCRIPTION
 *
 * This class implements basic SHA256 operations, used in a variety of places
 * throughout the projects.
 * 
 * Most of the SHA256 code can be pulled from elsewhere in the project.  Please
 * ensure that the forward hash function works for all lengths!
 */

#ifndef __CHHASHIMPLEMENTATIONSHA256_H__
#define __CHHASHIMPLEMENTATIONSHA256_H__

#include <CH_Common/CHHashImplementation.h>

class CHHashImplementationSHA256 : public CHHashImplementation {
public:
