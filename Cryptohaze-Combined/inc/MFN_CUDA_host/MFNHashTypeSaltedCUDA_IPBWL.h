...
extern "C" cudaError_t MFNHashTypeSaltedCUDA_IPBWL_CopyValueToConstant(
...
extern "C" cudaError_t MFNHashTypeSaltedCUDA_IPBWL_LaunchKernel(
        uint32_t passwordLength, uint32_t Blocks, uint32_t Threads);

class MFNHashTypeSaltedCUDA_IPBWL : public MFNHashTypePlainCUDA {

public:
    MFNHashTypeSaltedCUDA_IPBWL();
protected:
    ...
    void copyWordlistSizeToDevice(uint32_t wordCount, uint8_t blocksPerWord);
};