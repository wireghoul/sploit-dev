...
extern "C" cudaError_t MFNHashTypePlainCUDA_TripleMD5_CopyValueToConstant(
        const char *symbolName, void *hostDataAddress, size_t bytesToCopy);

extern "C" cudaError_t MFNHashTypePlainCUDA_TripleMD5_LaunchKernel(uint32_t passwordLength, uint32_t Blocks, uint32_t Threads);

class MFNHashTypePlainCUDA_TripleMD5 : public MFNHashTypePlainCUDA {

public:
    MFNHashTypePlainCUDA_TripleMD5();
protected:
