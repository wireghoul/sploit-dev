...
#ifndef __CHHASHTYPEPLAINDUPLICATEDMD5_H
#define __CHHASHTYPEPLAINDUPLICATEDMD5_H
...
class CHHashTypePlainDuplicatedMD5 : public CHHashTypePlain {
public:
    CHHashTypePlainDuplicatedMD5();
