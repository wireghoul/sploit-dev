...
#ifndef __CHHASHTYPEPLAINDUPLICATEDNTLM_H
#define __CHHASHTYPEPLAINDUPLICATEDNTLM_H
...
class CHHashTypePlainDuplicatedNTLM : public CHHashTypePlain {
public:
    CHHashTypePlainDuplicatedNTLM();
