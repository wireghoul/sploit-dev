...
#ifndef __GRTREGENERATECHAINSMD5_H__
#define __GRTREGENERATECHAINSMD5_H__

#include "GRT_CUDA_host/GRTRegenerateChains.h"

extern "C" void copyMD5RegenerateDataToConstant(char *hostCharset, UINT4 hostCharsetLength,
        UINT4 hostChainLength, UINT4 hostTableIndex, UINT4 hostNumberOfThreads, unsigned char *hostBitmap,
        UINT4 hostNumberOfHashes);
extern "C" void setMD5RegenerateNumberOfChains(UINT4 numberOfChains);
...
class GRTRegenerateChainsMD5 : public GRTRegenerateChains {
public:
    GRTRegenerateChainsMD5();
