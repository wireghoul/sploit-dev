...
#ifndef __MFNHASHTYPEPLAINOPENCL_DOUBLESHA256_H
#define __MFNHASHTYPEPLAINOPENCL_DOUBLESHA256_H

#include "MFN_OpenCL_host/MFNHashTypePlainOpenCL.h"

class MFNHashTypePlainOpenCL_DoubleSHA256 : public MFNHashTypePlainOpenCL {

public:
    MFNHashTypePlainOpenCL_DoubleSHA256();
protected:
