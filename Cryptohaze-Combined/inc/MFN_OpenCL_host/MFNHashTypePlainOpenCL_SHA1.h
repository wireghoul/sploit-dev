...
#ifndef __MFNHASHTYPEPLAINOPENCL_SHA1_H
#define __MFNHASHTYPEPLAINOPENCL_SHA1_H

#include "MFN_OpenCL_host/MFNHashTypePlainOpenCL.h"

class MFNHashTypePlainOpenCL_SHA1 : public MFNHashTypePlainOpenCL {

public:
    MFNHashTypePlainOpenCL_SHA1();
protected:
