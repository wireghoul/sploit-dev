...
#ifndef __MFNHASHTYPEPLAINOPENCL_MD5WL_H
#define __MFNHASHTYPEPLAINOPENCL_MD5WL_H

#include "MFN_OpenCL_host/MFNHashTypePlainOpenCL.h"
#include "MFN_Common/MFNDefines.h"


class MFNHashTypePlainOpenCL_MD5WL : public MFNHashTypePlainOpenCL {

public:
    MFNHashTypePlainOpenCL_MD5WL();
protected:
