...
#ifndef __MFNHASHTYPEPLAINOPENCL_SMD5_H
#define __MFNHASHTYPEPLAINOPENCL_SMD5_H

#include "MFN_OpenCL_host/MFNHashTypePlainOpenCL.h"


class MFNHashTypePlainOpenCL_SMD5 : public MFNHashTypePlainOpenCL {

public:
    MFNHashTypePlainOpenCL_SMD5();
protected:
