...
#ifndef __MFNHASHTYPEPLAINOPENCL_SNTLM_H
#define __MFNHASHTYPEPLAINOPENCL_SNTLM_H

#include "MFN_OpenCL_host/MFNHashTypePlainOpenCL.h"

class MFNHashTypePlainOpenCL_SNTLM : public MFNHashTypePlainOpenCL {

public:
    MFNHashTypePlainOpenCL_SNTLM();
protected:
