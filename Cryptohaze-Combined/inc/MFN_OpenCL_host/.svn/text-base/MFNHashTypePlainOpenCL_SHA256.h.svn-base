...
#ifndef __MFNHASHTYPEPLAINOPENCL_SHA256_H
#define __MFNHASHTYPEPLAINOPENCL_SHA256_H

#include "MFN_OpenCL_host/MFNHashTypePlainOpenCL.h"

class MFNHashTypePlainOpenCL_SHA256 : public MFNHashTypePlainOpenCL {

public:
    MFNHashTypePlainOpenCL_SHA256();
protected:
