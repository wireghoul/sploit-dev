...
#ifndef __MFNHASHTYPEPLAINOPENCL_16HEX_H
#define __MFNHASHTYPEPLAINOPENCL_16HEX_H

#include "MFN_OpenCL_host/MFNHashTypePlainOpenCL.h"

class MFNHashTypePlainOpenCL_16HEX : public MFNHashTypePlainOpenCL {

public:
    MFNHashTypePlainOpenCL_16HEX();
protected:
