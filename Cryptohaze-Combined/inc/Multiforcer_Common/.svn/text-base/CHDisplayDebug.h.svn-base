...
#ifndef __CHDISPLAYNCURSESDEBUG_H
#define __CHDISPLAYNCURSESDEBUG_H
...
*/
class CHMultiforcerDisplayDebug : public CHDisplay {
private:

#if USE_BOOST_THREADS
    boost::mutex mutex2Boost;
#else
    pthread_mutex_t mutex2;  // Mutex for important things.
    pthread_mutexattr_t mutex2attr;
#endif

public:
    CHMultiforcerDisplayDebug();
    ~CHMultiforcerDisplayDebug();
