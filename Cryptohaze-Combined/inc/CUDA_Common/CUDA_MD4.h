...
// This file contains an implementation of MD4 for CUDA
...
*/
__device__ inline void CUDA_MD4(uint32_t b0, uint32_t b1, uint32_t b2, uint32_t b3, uint32_t b4, uint32_t b5, uint32_t b6, uint32_t b7,
