...
#ifndef _GRTCLREGENERATECHAINSSHA256_H
#define _GRTCLREGENERATECHAINSSHA256_H
...
class GRTCLRegenerateChainsSHA256 : public GRTCLRegenerateChains {
private:


public:
    // Default constructor
    GRTCLRegenerateChainsSHA256();
