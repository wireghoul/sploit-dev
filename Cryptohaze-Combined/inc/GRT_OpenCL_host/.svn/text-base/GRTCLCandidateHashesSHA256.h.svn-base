...
#ifndef _GRTCLCANDIDATEHASHESSHA256_H
#define _GRTCLCANDIDATEHASHESSHA256_H
...
class GRTCLCandidateHashesSHA256 : public GRTCLCandidateHashes {
private:


public:
    // Default constructor
    GRTCLCandidateHashesSHA256();
